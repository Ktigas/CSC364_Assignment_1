...
def processing_thread(connection, ip, port, forwarding_table_with_range, default_gateway_port, max_buffer_size=5120):
    # Router 5 is primarily an ENDPOINT router for 10.0.0.66/27
    # Based on forwarding table, it only delivers locally (default route is 127.0.0.1)
    ...
    while True:
        ...
        if new_ttl <= 0:
            ...
            # Shouldn't happen based on forwarding table
